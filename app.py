...
def ValuePredictor(data=pd.DataFrame):
    # Model name
    model_name = r'E:\MUHILAN 2024\Muhilan\Arts\loan-approval-prediction-main\loan-approval-prediction-main\train_code'
    # Directory where the model is stored
    model_dir = os.path.join(current_dir, model_name)
    # Load the model
    loaded_model = joblib.load(open('train_code/model.pkl', 'rb'))
    # Predict the data
